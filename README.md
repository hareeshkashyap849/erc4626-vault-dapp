...
[`erc4626-vault`](https://github.com/wuzilin-web3/erc4626-vault) — the contract,
...
| **The front end that reads it** | the console at <https://wuzilin-web3.github.io/vault-console/> is published as a static export, so it has **no route to this service** and says so on the history page. Pointing its `indexApiUrl` at a hosted instance of this API is the change that would light that page up. |
